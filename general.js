document.getElementById('upload-cpa-2').addEventListener('click', function () {
    ...
    if (file) {
        Papa.parse(file, {
            ...
            complete: function (results) {
                ...
                const uniqueTableBody = document.getElementById('unique-time-table-2').getElementsByTagName('tbody')[0];
